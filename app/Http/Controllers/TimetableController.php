...
class TimetableController extends Controller
{
    ...
    public function create()
    {
        ...
        PermissionHelper::denyUnlessFeature('create_timetable');
    ...
    public function store(Request $request)
    {
     ...
     if (!PermissionHelper::canFeature('create_timetable')) {
        return response()->json(['message' => 'Unauthorized. You do not have permission to create timetables.'], 403);
    }
    ...
    public function edit($id)
    {
        ...
        PermissionHelper::denyUnlessFeature('edit_timetable');
    ...
    if (!PermissionHelper::canFeature('delete_timetable')) {
        return response()->json(['message' => 'Unauthorized. You do not have permission to delete timetables.'], 403);
    }
    ...
    public function teacherTimetable()
    {
        ...
        PermissionHelper::denyUnlessFeature('view_teacher_schedule');
