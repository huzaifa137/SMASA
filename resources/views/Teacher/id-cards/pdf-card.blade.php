{{-- resources/views/teacher/id-cards/pdf-card.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .card-type-txt  { color: #fbbf24; font-size: 6px; font-weight: bold; letter-spacing: .05em; }
        ...
        .photo-initial { color: #0f766e; font-size: 18px; font-weight: bold; }
        .photo-gold { height: 2px; background: linear-gradient(90deg, #f59e0b, #fbbf24); margin-top: -2px; }

        .info-col { flex: 1; }
        .teacher-name { font-size: 7.5px; font-weight: bold; color: #0f172a; margin-bottom: 2px; }
        ...
        .card-foot {
            ...
            padding: 4px 7px; gap: 5px; background: #fff;
        }
        .qr-svg { width: 44px; height: 44px; }
        .qr-svg svg { width: 44px !important; height: 44px !important; }
        .foot-right { flex: 1; }
        .card-no-lbl { font-size: 5px; color: #94a3b8; font-weight: bold; text-transform: uppercase; margin-bottom: 2px; }
        .card-no-txt { font-size: 5.5px; color: #0f766e; font-family: monospace; word-break: break-all; }
        ...
        <div class="card-header">
            <div class="logo-box">
                @if($logoUrl)
                    <img src="{{ $logoUrl }}" alt="">
                @else
                    <span class="logo-placeholder"><i>S</i></span>
                @endif
            </div>
