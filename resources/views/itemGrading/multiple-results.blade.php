        ...
        <div class="container mt-4">
            ...
            <div class="card shadow-lg border-0">
                <div class="card-header text-white d-flex justify-content-between align-items-center"
                    ...
                    <h4 class="mb-0">
                        <i class="fa fa-school me-2"></i> {{ trans('common.school_id') }} - {{ $schoolNumber ?? 'N/A' }} ({{ $schoolName ?? '' }})
                    </h4>
                    <span class="badge bg-light text-dark">
                        <i class="fa fa-users me-1"></i> {{ $records->count() }} {{ trans('common.students') }}
                    </span>
                </div>
                    ...
                    @if ($records->count() > 0)
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered table-hover">
                                                        <thead class="table-light">
                                                            <tr>
                                                                <th width="10%">#</th>
                                                                <th width="40%">{{ trans('common.index_number') }}</th>
                                                                <th width="30%">{{ trans('common.marks') }} (0-100)</th>
                                                                <th width="20%">{{ trans('common.status') }}</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            @foreach ($records as $key => $record)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        @if ($markValue)
                                                                            <span class="badge bg-success">{{ trans('common.saved') }}
                                                                                ({{ $markValue }})</span>
                                                                        @else
                                                                            <span
                                                                                class="badge bg-warning text-dark">{{ trans('common.pending') }}</span>
                                                                        @endif
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <button type="button"
                                                            ...
                                                            <i class="fa fa-magic me-1"></i> {{ trans('common.fill_all') }} (with 0)
                                                        </button>
                                                        <button type="button"
                                                            class="btn btn-outline-danger btn-sm clear-all-btn">
                                                            <i class="fa fa-eraser me-1"></i> {{ trans('common.clear_all') }}
                                                        </button>
                                                    </div>
                                                    <button type="submit" class="btn text-white"
                                                        style="background-color: #5351e4;">
                                                        <i class="fa fa-save me-2"></i> {{ trans('common.save') }} {{ $subject->md_name }}
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="action-buttons">
                            <button type="button" class="btn btn-outline-primary" id="saveAllVisibleBtn">
                                <i class="fa fa-eye me-2"></i> {{ trans('common.save_current_subject') }}
                            </button>
                            <button type="button" class="btn btn-success" id="saveAllSubjectsBtn">
                                <i class="fa fa-save me-2"></i> {{ trans('common.save_all_subjects') }}
                            </button>
                        </div>
                    @else
                        <div class="alert alert-danger text-center">
                            <i class="fa fa-exclamation-triangle me-2"></i>{{ trans('common.no_records_found_for_selected_filters') }} .
                        </div>
                    @endif
