                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h1 class="display-5 fw-bold mb-3">
                            <i class="fas fa-chart-pie me-3"></i>{{ trans('common.academic_analytics_report') }}
                        </h1>
                        <p class="lead mb-2">
                            <i class="fas fa-calendar-alt me-2"></i>{{ $year }} {{ trans('common.academic_year') }}
                    ...
                    <div class="col-md-4 text-end">
                        <div class="mb-3">
                            <span class="badge bg-white text-dark p-3 me-2">
                                <i class="fas fa-file-pdf text-danger me-1"></i> {{ trans('common.generated') }}: {{ date('d M Y H:i') }}
                            </span>
                        </div>
                        <button class="print-btn me-2" onclick="window.print()">
                            <i class="fas fa-print me-2"></i>{{ trans('common.print') }}
                        </button>
                        <button class="export-btn" onclick="exportAllTables()">
                            <i class="fas fa-file-excel me-2"></i>{{ trans('common.export_all') }}
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-md-3 mb-3">
                    <div class="stat-card">
                        ...
                        <h6 class="text-muted mb-2">{{ trans('common.total_schools') }}</h6>
                ...
                <div class="col-md-3 mb-3">
                    <div class="stat-card">
                        ...
                        <h6 class="text-muted mb-2">{{ trans('common.total_students') }}</h6>
                ...
                <div class="col-md-3 mb-3">
                    <div class="stat-card">
                        ...
                        <h6 class="text-muted mb-2">{{ trans('common.overall_pass_rate') }}</h6>
                ...
                <div class="col-md-3 mb-3">
                    <div class="stat-card">
                        ...
                        <h6 class="text-muted mb-2">{{ trans('common.overall_fail_rate') }}</h6>
            ...
            <ul class="nav nav-tabs-custom" id="analyticsTabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="performance-tab" data-bs-toggle="tab" data-bs-target="#performance"
                        type="button">
                        <i class="fas fa-chart-line me-2"></i>{{ trans('common.school_performance') }}
                    </button>
                </li>
            </ul>
            ...
            <div class="tab-content" id="analyticsTabsContent">
                    ...
                    <div class="row">
                            ...
                            <div class="card shadow-sm border-0 rounded-4">
                                <div class="card-header bg-white border-0 pt-4">
                                    <h5 class="section-title mb-0">
                                        <i class="fas fa-flag me-2 text-primary"></i>{{ trans('common.school_registration_summary') }}
                                    </h5>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table table-hover">
                                            <thead class="bg-light">
                                                <tr>
                                                    ...
                                                    <th class="text-center">{{ trans('common.idaad') }} (0)</th>
                                                    <th class="text-center">{{ trans('common.thanawi') }} (A)</th>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card shadow-sm border-0 rounded-4">
                                <div class="card-header bg-white border-0 pt-4">
                                    <h5 class="section-title mb-0">
                                        <i class="fas fa-percent me-2 text-success"></i>{{ trans('common.pass') }}/{{ trans('common.fail_analysis') }}
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <div class="row mb-4">
                                        <div class="col-6">
                                            <div class="badge-pass text-center p-3 w-100">
                                                ...
                                                <small>{{ trans('common.idaad_pass_rate') }}</small>
                                        ...
                                        <div class="col-6">
                                            <div class="badge-pass text-center p-3 w-100">
                                                ...
                                                <small>{{ trans('common.thanawi_pass_rate') }}</small>
                                                <div class="progress mt-2">
                                                    <div class="progress-bar progress-bar-success"
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="badge-fail text-center p-3 w-100">
                                                ...
                                                <small> {{ trans('common.idaad_fail_rate') }}</small>
                                                <div class="progress mt-2">
                                        ...
                                        <div class="col-6">
                                            <div class="badge-fail text-center p-3 w-100">
                                                ...
                                                <small>{{ trans('common.thanawi_fail_rate') }}</small>
                                                <div class="progress mt-2">
                                                    <div class="progress-bar progress-bar-danger"
                ...
                <div class="tab-pane fade" id="schools" role="tabpanel">
                    <div class="card shadow-sm border-0 rounded-4">
                        <div class="card-header bg-white border-0 pt-4 d-flex justify-content-between align-items-center">
                            <h5 class="section-title mb-0">
                                <i class="fas fa-school me-2 text-primary"></i>{{ trans('common.schools_registration') }} ({{ $year }})
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover data-table" id="schoolsTable">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>{{ trans('common.school_code') }}</th>
                                            <th>{{ trans('common.school_name') }}</th>
                                            <th class="text-center">{{ trans('common.idaad') }} (0 Level)</th>
                                            <th class="text-center">{{ trans('common.thanawi') }}(A Level)</th>
                                            <th class="text-center">{{ trans('common.total_students') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <tfoot class="bg-light fw-bold">
                                        <tr>
                                            <td colspan="3">{{ trans('common.grand_totals') }}</td>
                                            <td class="text-center">
                                                {{ array_sum(array_column($schoolRegistration, 'idaad')) }}</td>
                                            <td class="text-center">
                                                {{ array_sum(array_column($schoolRegistration, 'thanawi')) }}</td>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card shadow-sm border-0 rounded-4 h-100">
                                <div class="card-header bg-warning text-white rounded-top-4">
                                    <h5 class="mb-0"><i class="fas fa-trophy me-2"></i>{{ trans('common.top 10 students') }} ({{ trans('common.overall') }})</h5>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-sm">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>{{ trans('common.student_id') }}</th>
                                                    <th>{{ trans('common.percentage') }}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @foreach ($topTenOverall as $index => $student)
                                                    <tr>
                                                        <td>
                                                            @if ($index == 0)
                                                                <span class="student-rank-1">🥇 {{ trans('common.1st') }}</span>
                                                            @elseif($index == 1)
                                                                <span class="student-rank-2">🥈 {{ trans('common.2nd') }}</span>
                                                            @elseif($index == 2)
                                                                <span class="student-rank-3">🥉 {{ trans('common.3rd') }}</span>
                                                            @else
                                                                <span
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card shadow-sm border-0 rounded-4 h-100">
                                <div class="card-header bg-success text-white rounded-top-4">
                                    <h5 class="mb-0"><i class="fas fa-graduation-cap me-2"></i>{{ trans('common.top 10 thanawi') }}(A Level)
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card shadow-sm border-0 rounded-4 h-100">
                                <div class="card-header bg-info text-white rounded-top-4">
                                    <h5 class="mb-0"><i class="fas fa-school me-2"></i>{{ trans('common.Top 10 Idaad') }} (O Level)</h5>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-sm">
                ...
                <div class="tab-pane fade" id="subjects" role="tabpanel">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card shadow-sm border-0 rounded-4">
                                <div class="card-header bg-success text-white rounded-top-4">
                                    <h5 class="mb-0"><i class="fas fa-star me-2"></i>{{ trans('common.best 10 subjects') }} - A Level
                                        (Thanawi)</h5>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">{{ trans('common.average') }}</th>
                                                    <th class="text-center">{{ trans('common.students') }}</th>
                                                    <th class="text-center">{{ trans('common.max') }}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card shadow-sm border-0 rounded-4">
                                <div class="card-header bg-info text-white rounded-top-4">
                                    <h5 class="mb-0"><i class="fas fa-star me-2"></i>{{ trans('common.best 10 subjects') }} - O Level (Idaad)
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card shadow-sm border-0 rounded-4">
                                <div class="card-header bg-danger text-white rounded-top-4">
                                    <h5 class="mb-0"><i class="fas fa-exclamation-triangle me-2"></i>{{ trans('common.5 Worst Subjects ') }}-
                                        A Level (Thanawi)</h5>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">{{ trans('common.average') }}</th>
                                                    <th class="text-center">{{ trans('common.students') }}</th>
                                                    <th class="text-center">{{ trans('common.min') }}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                ...
                <div class="tab-pane fade" id="performance" role="tabpanel">
                    <div class="card shadow-sm border-0 rounded-4">
                        <div class="card-header bg-white border-0 pt-4">
                            <h5 class="section-title mb-0">
                                <i class="fas fa-chart-bar me-2 text-primary"></i>{{ trans('common.general_performance') }} - Idaad (O Level) {{ trans('common.by') }}
                                {{ trans('common.school') }}
                            </h5>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-striped table-hover data-table" id="performanceTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ trans('common.school_name') }}</th>
                                            <th class="text-center">{{ trans('common.total_students') }}</th>
                                            <th class="text-center">{{ trans('common.1st class') }}</th>
                                            <th class="text-center">{{ trans('common.2nd class_upper') }}</th>
                                            <th class="text-center">{{ trans('common.2nd class_lower') }}</th>
                                            <th class="text-center">{{ trans('common.3rd class') }}</th>
                                            <th class="text-center">{{ trans('common.fail') }}</th>
                                            <th class="text-center">{{ trans('common.pass') }} %</th>
                                        </tr>
                                    </thead>
                                    <tbody>
            ...
            <div class="row mt-4 mb-5">
                <div class="col-12 text-center">
                    <a href="{{ route('iteb.analytics.dashboard') }}" class="btn btn-secondary btn-lg px-5">
                        <i class="fas fa-arrow-left me-2"></i>{{ trans('common.back_to_dashboard') }}
                    </a>
                    <a href="{{ route('iteb.grading.summary') }}" class="btn btn-primary btn-lg px-5 ms-2">
                        <i class="fas fa-calculator me-2"></i>{{ trans('common.go_to_grading') }}
                    </a>
                </div>
            </div>
