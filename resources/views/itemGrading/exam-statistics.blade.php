            ...
            <div class="modern-card section-wrapper">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4>
                        ...
                        <span class="gradient-text-white">{{ trans('common.exam_statistics_dashboard') }}</span>
                    </h4>
                    <div class="d-flex">
                        <button class="export-btn mr-2" onclick="downloadPdf()">
                            <i class="fas fa-file-pdf"></i>
                            {{ trans('common.generate_report') }}
                        </button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="category" id="categorySelect" class="modern-select" required>
                                ...
                                <option value="ID" {{ $category == 'ID' ? 'selected' : '' }}>{{ trans('common.idaad') }} (ID)</option>
                                <option value="TH" {{ $category == 'TH' ? 'selected' : '' }}>{{ trans('common.thanawi') }} (TH)</option>
                            </select>
                        </div>
                        <div class="col-md-3">
                            <label class="filter-label">
                                <i class="fas fa-signal me-2" style="color: var(--primary-green);"></i>
                               {{ trans('common.master_code') }} Level
                            </label>
                        ...
                        <div class="col-md-3">
                            ...
                            <button type="submit" class="btn-primary-green" id="submitBtn">
                                <span id="btnText">
                                  ...
                                  {{ trans('common.fetch_records') }}  
                                </span>

                                <span id="btnLoader" style="display: none;">
                                    <i class="fas fa-spinner fa-spin"></i>
                                  {{ trans('common.fetching_records') }}  ...
                                </span>
                            </button>
                        </div>
                    </div>
            ...
            @if(isset($registeredStudents))
                ...
                <div class="summary-grid section-wrapper">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-label">{{ trans('common.failed_students') }}</div>
                        <div class="stat-value">{{ number_format($failedBreakdown['total_failed']) }}</div>
                        <div class="stat-trend">
                            <i class="fas fa-exclamation-triangle" style="color: #dc2626;"></i>
                           {{ trans('common.critical_attention') }} 
                        </div>
                    </div>
                </div>
            @endif
            ...
            @if(isset($schoolsTable))
                ...
                <div class="modern-card section-wrapper">
                    <div class="card-header">
                        <h6>
                            ...
                            {{ trans('common.registered_schools') }} - {{ $year }}
                        </h6>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="modern-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ trans('common.number_of_school') }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @php
                ...
                <div class="modern-card section-wrapper">
                    <div class="card-header">
                        <h6>
                            ...
                            {{ trans('common.grading_summary') }} (Passing Grades Only) - {{ $levelName }}
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="modern-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">{{ trans('common.male') }}</th>
                                        <th class="text-center">%</th>
                                        <th class="text-center">{{ trans('common.female') }}</th>
                                        <th class="text-center">%</th>
                                ...
                                <tbody>
                                    ...
                                    <tr style="background: #e8f5e9; font-weight: bold;">
                                        <td class="fw-bold">{{ trans('common.subtotal') }} (Passing Grades)</td>
                                    ...
                                    <tr style="background: #f8fafc;">
                                        <td class="fw-bold">{{ trans('common.total ') }}(All Students)</td>
                ...
                <div class="modern-card section-wrapper">
                    <div class="card-header" style="background: linear-gradient(135deg, #dc2626, #b91c1c);">
                        <h6>
                           ...
                           {{ trans('common.students_failed') }}  - {{ $levelName }}
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="modern-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="fw-bold">{{ trans('common.failed_students') }}</td>
                                        <td class="text-center">
                ...
                @if(isset($topStudents) && count($topStudents) > 0)
                    <div class="section-title d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            {{ trans('common.top 10 students') }} - {{ $levelName }}
                        </div>
                        <button class="export-btn" onclick="downloadStudentsFullReport()">
                            <i class="fas fa-file-pdf"></i>
                            {{ trans('common.download_full_report') }}
                        </button>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="modern-table">
                                    <thead>
                                        <tr>
                                            <th class="text-center">{{ trans('common.rank') }}</th>
                                            <th>{{ trans('common.student') }}</th>
                                            <th>{{ trans('common.school') }}</th>
                                            <th class="text-center">{{ trans('common.gender') }}</th>
                                            <th class="text-center">{{ trans('common.marks') }}</th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @if(strtolower($student['gender']) == 'male')
                                                        <span class="modern-badge info">
                                                            <i class="fas fa-mars"></i>{{ trans('common.male') }} 
                                                        </span>
                                                    @else
                                                        <span class="modern-badge danger">
                                                            <i class="fas fa-venus"></i>{{ trans('common.female') }} 
                                                        </span>
                                                    @endif
                                                </td>
                ...
                @if(isset($bestSubjects) && isset($worstSubjects))
                    <div class="section-title">
                       ...
                       {{ trans('common.subject_performance_analysis') }} 
                    </div>
                    ...
                    <div class="subject-grid section-wrapper">
                        ...
                        <div class="modern-card">
                            <div class="card-header"
                                ...
                                <h6>
                                  ...
                                  {{ trans('common.best_performing_subjects') }}  
                                </h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="modern-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">{{ trans('common.pass_rate') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach($bestSubjects as $index => $subject)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <small class="text-muted">{{ $subject['student_count'] }} {{ trans('common.students') }}</small>
                                                    </td>
                                                    <td class="text-center">
                                                        <span class="modern-badge success">
                        ...
                        <div class="modern-card">
                            <div class="card-header" style="background: linear-gradient(135deg, #dc2626, #b91c1c);">
                                <h6>
                                    <i class="fas fa-exclamation-triangle me-2"></i>
                                   {{ trans('common.worst_done_subjects') }} 
                                </h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                ...
                @if(isset($topSchools) && count($topSchools) > 0)
                    <div class="section-title d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            {{ trans('common.top 10 best performing schools') }} - {{ $levelName }}
                        </div>
                    ...
                    <div class="modern-card section-wrapper">
                        <div class="card-header" style="background: linear-gradient(135deg, var(--primary-green), #0e5e2c);">
                            <h6>
                                <i class="fas fa-trophy me-2"></i>
                                {{ trans('common.school_performance_summary') }}
                            </h6>
                        </div>
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="school-performance-table">
                                    <thead>
                                        <tr>
                                            <th rowspan="2" style="background: #0e5e2c; width: 60px;">{{ trans('common.rank') }}</th>
                                            <th rowspan="2" style="background: #0e5e2c; text-align: left; min-width: 250px;">{{ trans('common.school') }}
                                            </th>
                                            <th rowspan="2" style="background: #0e5e2c; width: 80px;">{{ trans('common.total') }}<br>Std</th>
                                            <th colspan="5" style="background: #0e5e2c; text-align: center;">{{ trans('common.grade_distribution') }}</th>
                                            <th rowspan="2" style="background: #0e5e2c; width: 70px;">{{ trans('common.graded') }}</th>
                                            <th rowspan="2" style="background: #0e5e2c; width: 80px;">{{ trans('common.average') }}<br>%</th>
                                            <th rowspan="2" style="background: #0e5e2c; width: 80px;">{{ trans('common.pass_rate') }}</th>
                                        </tr>
                                        <tr>
