                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6">
                                    <label class="form-label fw-bold">
                                        {{ trans('common.year') }} <span class="text-danger">*</span>
                                    </label>
                                ...
                                <div class="col-12 col-md-6">
                                    <label class="form-label fw-bold">
                                        {{ trans('common.category') }} <span class="text-danger">*</span>
                                    </label>
                    ...
                    <div class="mb-4 pb-3 mt-4 border-bottom">
                        ...
                        <form action="{{ route('iteb.process.grading') }}" method="POST" id="gradingFilterForm">
                            ...
                            <div class="row g-3">
                                ...
                                <!-- School -->
                                <div class="col-12 col-md-4">
                                    <label class="form-label fw-bold">{{ trans('common.school') }}</label>
                                    ...
                                    <div style="height: 21px;">
                                        <small class="text-muted">{{ trans('common.optional') }}</small>
                                    </div>
                                </div>
                    ...
                    <div class="row mt-4 pt-3 border-top">
                        <div class="col-md-3 col-6">
                            <div class="bg-light p-2 rounded text-center">
                                <small class="text-muted">{{ trans('common.total_schools') }}</small>
                                <h6 class="mb-0">{{ count($schools ?? []) }}</h6>
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <div class="bg-light p-2 rounded text-center">
                                <small class="text-muted">{{ trans('common.categories') }}</small>
                                <h6 class="mb-0">{{ count($categories ?? []) }}</h6>
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <div class="bg-light p-2 rounded text-center">
                                <small class="text-muted">{{ trans('common.years_active') }}</small>
                                <h6 class="mb-0">{{ count($years ?? []) }}</h6>
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <div class="bg-light p-2 rounded text-center">
                                <small class="text-muted">{{ trans('common.last_search') }}</small>
