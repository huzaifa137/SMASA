...
<head>
    ...
    <title>{{ trans('common.exam_statistics_report') }}</title>
    <style>
...
<body>
    ...
    <div class="section-head">1.{{ trans('common.NUMBER_OF_SCHOOLS_REGISTERED') }} </div>
    <table>
        <thead>
            <tr>
                <th width="10%">S/N</th>
                <th width="45%">{{ trans('common.level') }} </th>
                <th width="45%">{{ trans('common.number_of_schools') }} </th>
            </tr>
        </thead>
        <tbody>
            @php
    ...
    <div class="section-head">2. {{ trans('common.NUMBER_OF_STUDENTS_REGISTERED') }}</div>
    <table>
        <thead>
            <tr>
                <th width="10%">S/N</th>
    ...
    <div class="section-head">3. {{ trans('common.grading_summary') }} - {{ $levelName }}</div>
    <table>
        <thead>
            <tr>
                <th width="8%">S/N</th>
        ...
        <tbody>
            ...
            <tr style="background-color: #e8f5e9; font-weight: bold;">
                <td colspan="2" class="text-right">{{ trans('common.subtotal') }}(Passing Grades D1-C4)</td>
            ...
            <tr style="background-color: #f0f0f0; font-weight: bold; border-top: 2px solid #17a2b8;">
                <td colspan="2" class="text-right">{{ trans('common.grand_total') }}(All Students)</td>
    ...
    <div class="section-head-danger">4. {{ trans('common.students_failed') }}- {{ $levelName }}</div>
    <table>
        <thead>
            <tr>
                <th width="35%">{{ trans('common.category') }}</th>
                <th width="21.67%">{{ trans('common.male') }}</th>
                <th width="21.67%">{{ trans('common.female') }}</th>
                <th width="21.66%">{{ trans('common.total') }}</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td class="fw-bold">{{ trans('common.students_failed') }} (Grade F)</td>
                <td class="text-center">
            ...
            <tr style="background-color: #f8fafc;">
                <td class="text-right fw-bold">{{ trans('common.Percentage_of_Total') }}</td>
                <td class="text-center">
                    <span class="badge badge-danger">
                        {{ $totals['overall_total'] > 0 ? round(($failedBreakdown['male_failed'] / $totals['overall_total']) * 100, 2) : 0 }}%
                    </span>
    ...
    <!-- 5. Top 10 Students -->
    <div class="section-head">5.{{ trans('common.TOP 10 PERFORMING STUDENTS') }} TOP 10 PERFORMING STUDENTS - {{ $levelName }}</div>
    <table>
        <thead>
            <tr>
                ...
                <th width="10%">{{ trans('common.marks') }}</th>
                <th width="12%">{{ trans('common.percentage') }}</th>
    ...
    <div class="section-head">6. {{ trans('common.TOP 10 BEST PERFORMING SUBJECTS') }}</div>
    <table>
        <thead>
            <tr>
                <th width="8%">{{ trans('common.rank') }}</th>
    ...
    <div class="section-head">7. {{ trans('common.TOP 10 WORST PERFORMING SUBJECTS') }}</div>
    <table>
        <thead>
            <tr>
                <th width="8%">{{ trans('common.rank') }}</th>
