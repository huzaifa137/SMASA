...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Fredoka:wght@400;500;600;700&family=Poppins:ital,wght@0,400;0,500;0,600;1,400&display=swap"
    rel="stylesheet">
  ...
  <style>
    ...
    * {
    ...
    .sheet>*:not(.watermark):not(.watermark-text) {
      position: relative;
      z-index: 1;
    }
    ...
    .hero-logo-icon .fa-shield-halved {
      position: absolute;
      top: 2.24mm;
      left: 50%;
      transform: translateX(-50%);
      font-size: 11.52mm;
      background: linear-gradient(160deg, #f0d49a, #a9762e);
      -webkit-background-clip: text;
      background-clip: text;
      color: transparent;
    }

    .hero-logo-icon .fa-book-open {
      position: absolute;
      top: 5.44mm;
      left: 50%;
      transform: translateX(-50%);
    ...
    .hero-logo-icon .fa-wheat-awn.left {
      left: -0.64mm;
      transform: scaleX(-1) rotate(8deg);
    }

    .hero-logo-icon .fa-wheat-awn.right {
      right: -0.64mm;
    ...
    .hero-logo--custom .hero-logo-badge img {
      width: 100%;
      height: 100%;
      object-fit: contain;
      padding: 0.96mm;
    ...
    /* When the school has an actual logo, skip the navy pennant panel
  entirely — it's only a placeholder frame for the generic icon/"YOUR
  LOGO" text, and otherwise sits on top of (and hides part of) the
  hero illustration behind a real logo. Just the white circular badge
  and "SINCE" caption remain, with a text-shadow so the caption still
  reads over whatever part of the illustration is behind it. */
    .hero-logo.hero-logo--custom {
      background: transparent;
      clip-path: none;
      border: none;
    }

    .hero-logo.hero-logo--custom .hero-logo-sub {
    ...
    .dev-card-divider .dcd-line {
      height: 1px;
      flex: 1;
      background: var(--dc-color, #c7c2b3);
      max-width: 7mm;
    }

    .dev-card-divider i {
      font-size: 6px;
      color: var(--dc-color, #c7c2b3);
      flex: none;
    }
    ...
    .term-fee-icon {
      ...
      color: #fff;
      font-size: 8.5px;
      background: var(--tf-color, var(--navy));
    }
