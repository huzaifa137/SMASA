...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .toolbar-info strong { color:#fff; font-size:.9rem; font-weight:700; font-family:var(--font-display); }
        ...
        .tbtn-print { background:var(--accent); color:#fff; }
        .tbtn-print:hover { background:var(--accent-dark); transform:translateY(-1px); }
        ...
        /* ══════════════════════════════════════════════════════════════
           PAGE WRAPPER
        ══════════════════════════════════════════════════════════════ */
        .page-wrap { max-width:800px; margin:1.5rem auto; }
        ...
        .sch-text { flex:1; text-align:right; }
        ...
        .sch-details { font-size:11.5px; color:#555; margin-top:3px; }
        .sch-motto   { font-family:var(--font-display); font-size:12px; font-style:italic; color:#777; margin-top:3px; }
        ...
        .sch-logo-box i   { font-size:1.8rem; color:var(--accent); }
        ...
        .nophoto {
            ...
            justify-content:center; width:100%; height:100%; gap:.2rem;
            background:#e8e8e8;
        }
        .nophoto i    { font-size:2.8rem; color:#b0b0b0; }
        .nophoto span { font-size:.55rem; color:#aaa; text-transform:uppercase; letter-spacing:.04em; }
        ...
        .stu-chart-area {
            ...
            display:flex; flex-direction:column; padding-left:.4rem;
        }
        .stu-chart-title {
            font-family:var(--font-display); font-size:.73rem; font-weight:700;
            color:#555; text-align:center; margin-bottom:.25rem;
        }
        ...
        .stu-qr-col {
            ...
            gap:.45rem; border-right:1.5px solid #e8e8e8; padding-right:1rem;
        }
        .stu-qr-title  { font-size:.65rem; font-weight:800; color:#666; text-transform:uppercase; letter-spacing:.08em; }
        .stu-qr-box    {
            width:130px; height:130px; border:2.5px solid var(--accent);
            border-radius:10px; padding:6px; background:#fff;
            display:flex; align-items:center; justify-content:center;
            box-shadow:0 4px 14px var(--accent-a22);
        }
        .stu-qr-box canvas, .stu-qr-box img, .stu-qr-box svg {
            width:100% !important; height:100% !important;
            display:block; object-fit:contain;
        }
        .stu-qr-label  { font-size:.68rem; font-weight:900; color:var(--accent); letter-spacing:.12em; text-transform:uppercase; }

        /* ══════════════════════════════════════════════════════════════
           SUMMARY BAR
        ══════════════════════════════════════════════════════════════ */
        .sum-bar { display:flex; background:#e8ecf0; border-bottom:1.5px solid #c8c8c8; direction:rtl; }
        .sum-cell {
        ...
        .sum-lbl { font-family:var(--font-display); font-size:.68rem; text-transform:uppercase; letter-spacing:.04em; color:#777; font-weight:700; }
        ...
        .delta-inline { font-size:.72rem; font-weight:700; margin-right:.25rem; vertical-align:middle; }
        .di-up  { color:#1a7a4a; }
        .di-dn  { color:#c0392b; }
        ...
        ══════════════════════════════════════════════════════════════ */
        .marks-wrap { padding:0 1.2rem .5rem; }
        ...
        .marks-tbl th:last-child { border-left:none; }
        .marks-tbl th.tr { text-align:right; }

        .marks-tbl td { padding:.34rem .55rem; border:1px solid #ddd; vertical-align:middle; }
        .marks-tbl tbody tr:nth-child(even) { background:#f9f9fb; }
        .marks-tbl tbody tr:hover           { background:#f0faf3; }
        ...
        .score-td { text-align:center; font-weight:700; font-size:.82rem; }

        .g-pill {
            display:inline-block; min-width:24px; text-align:center;
            padding:.1rem .35rem; border-radius:3px; font-weight:800; font-size:.72rem;
        }
        ...
        .totals-row td {
            background:#f0f0f0; font-weight:800; font-size:.78rem;
        ...
        ══════════════════════════════════════════════════════════════ */
        .bottom-section {
            display:flex; gap:0; border-top:1.5px solid #ddd; min-height:200px; direction:rtl;
        }
        ...
        .perf-chart-title {
            ...
            color:#111; margin-bottom:.5rem; letter-spacing:.01em;
        }
        ...
        .remarks-section-title {
            ...
            color:#555; border-bottom:1px dashed #ccc; padding-bottom:.2rem; margin-bottom:.2rem;
        }
        .remark-block    { margin-bottom:.4rem; }
        .remark-teacher  { font-size:.77rem; font-weight:700; color:#111; }
        .remark-text     { font-size:.75rem; color:#444; line-height:1.5; margin-top:.15rem; }

        .sig-dashes {
            border-top:1px dashed #bbb; margin:.55rem 0 .15rem;
            padding-top:.2rem; font-size:.62rem; color:#aaa; text-transform:uppercase;
        }

        .sig-col-right {
            flex:0 0 130px; padding:.7rem .8rem; border-right:1.5px solid #ddd;
            display:flex; flex-direction:column; gap:.5rem; align-items:center;
        }
        .sig-col-title {
            font-family:var(--font-display); font-size:.72rem; font-weight:700;
            color:#555; border-bottom:1px dashed #ccc; padding-bottom:.2rem; width:100%;
        }
        .sig-slot {
            width:100%; text-align:center; border-bottom:1px solid #999;
            padding-bottom:.15rem; font-size:.63rem; color:#999;
        ...
        .slip-footer {
            ...
            padding:.45rem 1.2rem; border-top:1.5px solid #ddd;
            background:#fafafa; gap:.5rem; flex-wrap:wrap; direction:rtl;
        }
        ...
        .slip > *:not(.watermark):not(.watermark-text) { position:relative; z-index:1; }
        ...
        @media print {
            ...
            .slip { margin:0; box-shadow:none; page-break-after:always; }
            .slip.has-border { border:3px solid var(--accent); outline:1px solid var(--accent-dark); outline-offset:-6px; }
            .slip:last-child  { page-break-after:avoid; }

            .slip::before,.slip::after,.title-band,.grp-row td,.g-pill,
            .g-A,.g-B,.g-C,.g-D,.g-P,.g-F,
            .marks-tbl thead,.sch-header,.sum-bar,.slip-footer,
            .status-promoted,.status-repeat,.status-fail,
            .watermark,.watermark-text,.watermark img,
            .stu-qr-box,.stu-qr-box img,.geo-strip {
            ...
            @php
                ...
                if (!empty($s->student_photo)) {
                    foreach (['jpg','jpeg','png','gif'] as $ext) {
                        $fp = str_replace('/',DIRECTORY_SEPARATOR,
            ...
            <div class="slip {{ $cfg['border'] ? 'has-border' : '' }}">
                ...
                <div class="sch-header">
                    ...
                    <div class="sch-text">
                        ...
                        @endif
                        <div class="sch-name-latin">{{ $schoolName }}</div>
                        ...
                        @if($cfg['motto'] && $schoolMotto)
                            <div class="sch-motto">{{ $schoolMotto }}</div>
                        @endif
                    </div>
                </div>
                ...
                <div class="sum-bar">
                    <div class="sum-cell">
                        ...
                        <div class="sum-val">
                            {{ number_format($totObt,0) }}<span style="font-size:.65rem;color:#aaa;font-weight:500;">/{{ $totMax }}</span>
                        </div>
                    </div>
                    <div class="sum-cell">
                    ...
                    <table class="marks-tbl">
                        <thead>
                            <tr>
                                ...
                                @if($cfg['dev'])   <th style="width:42px;">{{ $ar['dev'] }}</th>  @endif
                                @if($cfg['grade_pill']) <th style="width:42px;">{{ $ar['grade'] }}</th> @endif
                                <th class="tr">{{ $ar['comment'] }}</th>
                                @if($cfg['teacher_col']) <th class="tr" style="min-width:100px;">{{ $ar['teacher'] }}</th> @endif
                            </tr>
                        </thead>
                        <tbody>
                            @php $rn = 0; @endphp
                            ...
                            @if($cfg['totals_row'])
                                <tr class="totals-row">
                                    <td style="text-align:right;color:#666;font-size:.74rem;padding-left:.8rem;font-weight:600;">
                                        {{ $ar['total_avg_row'] }}
                                    </td>
                            ...
                            <div class="remarks-col">
                                ...
                                <div class="remark-block">
                                    <div class="remark-teacher">
                                        ...
                                        — <span style="font-weight:400;color:#888;font-size:.72rem;">{{ $ar['class_teacher'] }}</span>
                                    </div>
                                ...
                                <div class="remark-block">
                                    <div class="remark-teacher">
                                        ...
                                        — <span style="font-weight:400;color:#888;font-size:.72rem;">{{ $ar['head_teacher'] }}</span>
                                    </div>
