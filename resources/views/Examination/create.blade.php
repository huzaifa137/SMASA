...
@section('css')
    ...
    <style>
        ...
        .cs-item:hover { border-color: #5351e4; background: #f5f4ff; }
        .cs-item.selected { border-color: #2C29CA; background: #ede9ff; color: #2C29CA; font-weight: 600; }
        .cs-item .cs-icon {
        ...
        .cs-item.selected .cs-icon { background: #2C29CA; color: #fff; }
...
<div class="side-app">
    ...
    <div class="exam-hero mb-4">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h3 class="text-white mb-1 fw-bold"><i class="fas fa-file-alt me-2"></i> Create Examination</h3>
            ...
            <a href="{{ route('examination.index') }}" class="btn btn-light btn-sm fw-semibold" style="border-radius:.5rem;">
                <i class="fas fa-list me-1"></i> All Examinations
            </a>
        </div>
    </div>
                ...
                <div class="card form-card mb-3">
                    <div class="card-body p-4">
                        <div class="section-header">
                            ...
                            <i class="fas fa-info-circle"></i> Examination Details
                        </div>
                        <div class="row g-3">
                            <div class="col-md-8">
                                <label class="form-label fw-semibold">Examination Name <span class="text-danger">*</span></label>
                                <input type="text" name="exam_name" class="form-control" placeholder="e.g. End of Term 1 Examinations 2025">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-semibold">Exam Code</label>
                                <input type="text" name="exam_code" id="exam_code" class="form-control bg-light" value="{{ $examCode }}" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-semibold">Examination Type <span class="text-danger">*</span></label>
                                <select name="exam_type" class="form-control form-select">
                                    <option value="">-- Select Type --</option>
                                    <option value="Opening Test">Opening Test</option>
                                    <option value="Mid-Term">Mid-Term</option>
                                    <option value="End-of-Term">End-of-Term</option>
                                    <option value="Mock">Mock Examination</option>
                                    <option value="Final">Final Examination</option>
                                    <option value="UNEB">UNEB / National Exam</option>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="academic_year" class="form-control" value="{{ date('Y') }}" min="2000" max="2099" placeholder="{{ date('Y') }}">
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-semibold">Description / Notes</label>
                                <textarea name="description" class="form-control" rows="2" placeholder="Optional internal notes about this examination..."></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card form-card mb-3">
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <label class="form-label fw-semibold">
                                    ...
                                    <i class="fas fa-info-circle text-muted ms-1" title="Teachers cannot enter marks after this date." data-bs-toggle="tooltip"></i>
                                </label>
                        ...
                        <div class="alert alert-info mt-3 py-2 mb-0" style="font-size:.82rem; border-radius:.6rem;">
                            ...
                            Once the <strong>Marks Entry Deadline</strong> passes, the system will automatically close the examination and prevent further mark submissions.
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="total_marks" class="form-control" value="100" min="1" max="1000">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="mt-3 p-3 rounded" style="background:#f8f7ff; border:1px solid #ede9ff; font-size:.82rem;">
                            <strong><i class="fas fa-table me-1 text-primary"></i> Grading Scale (Uganda O-Level)</strong><br>
                ...
                <div class="card form-card h-100">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3 text-white">
                            <span id="selectedCount" class="badge bg-primary" style="font-size:.78rem;">0 selected</span>
                            <button type="button" id="toggleAllClasses" class="btn btn-sm btn-outline-primary" style="border-radius:.5rem; font-size:.8rem;">
                        ...
                        <div class="class-stream-grid" id="classStreamGrid">
                            @forelse ($classStreams as $cs)
                                <div class="cs-item"
                                     data-value="{{ $cs->class_id }}_{{ $cs->stream_id }}"
            ...
            <div class="col-12">
                <div class="card form-card">
                    <div class="card-body p-3 d-flex justify-content-between align-items-center">
                        ...
                        <button type="submit" class="btn text-white submit-btn">
