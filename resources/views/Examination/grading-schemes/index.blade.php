                    ...
                    <div class="gs-topbar-v2-left">
                        ...
                        <div class="gs-topbar-v2-content">
                            <div class="gs-topbar-v2-badge">
                                ...
                                <span class="text-white">Grading Management</span>
                            </div>
                            <h3 class="gs-topbar-v2-title">Grading Schemes</h3>
                            <p class="gs-topbar-v2-subtitle">Define how marks translate into grades — pick a scheme whenever
                                you create an examination.</p>
                        </div>
                    </div>
                            ...
                            <div class="gs-detail {{ $loop->first ? 'active' : '' }}" id="scheme-detail-{{ $scheme->id }}">
                                <div class="detail-top">
                                    ...
                                    <div class="detail-actions">
                                        <button type="button" class="icon-btn edit-scheme" data-id="{{ $scheme->id }}" title="Edit">
                                        ...
                                        <button type="button" class="icon-btn danger delete-scheme" data-id="{{ $scheme->id }}"
                                            title="Delete">
