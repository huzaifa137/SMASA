            ...
            <div class="card box-widget widget-user">
                ...
                <div class="card-body text-center">
                    <div class="pro-user">
                        ...
                        @endif
                        @if ($user->user_role == 1)
                            <h6 class="pro-user-desc text-muted">{{ trans('common.Enrolled_as') }} : {{ trans('common.student') }}</h6>
                        @else
                            <h6 class="pro-user-desc text-muted">{{ trans('common.Enrolled_as') }} : {{ trans('common.admin') }}</h6>
                        @endif
                        @if ($user->account_status == 10)
                            <a href="#" class="btn btn-success btn-sm mt-3">
                                <i class="fas fa-check-circle"></i>{{ trans('common.account') }}  {{ trans('common.status') }}: {{ trans('common.active') }}
                            </a>
                        @elseif ($user->account_status == 0)
                            <a href="#" class="btn btn-danger btn-sm mt-3">
                                <i class="fas fa-ban"></i>{{ trans('common.account') }} {{ trans('common.status') }}: {{ trans('common.banned') }}
                            </a>
                        @elseif ($user->account_status == 8)
                            <a href="#" class="btn btn-secondary btn-sm mt-3">
                                <i class="fas fa-lock"></i> {{ trans('common.account') }} {{ trans('common.status') }}: {{ trans('common.locked') }}
                            </a>
                        @elseif ($user->account_status == 9)
                            <a href="#" class="btn btn-warning btn-sm mt-3 text-white">
                                <i class="fas fa-exclamation-triangle"></i> {{ trans('common.account') }} {{ trans('common.status') }}: {{ trans('common.locked') }}
                            </a>
                        @endif
                    ...
                    <div class="row">
                        <div class="col-sm-12 border-right text-center">
                            <div class="description-block p-4">
                                ...
                                <span class="text-muted">{{ trans('common.Enrolled_Courses') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card border p-0 shadow-none">
                                    ...
                                    <div class="d-flex align-items-center p-4">
                                        ...
                                        <div class="wrapper ml-3">
                                            ...
                                            @if ($user->user_role == 1)
                                                <small class="text-muted">{{ trans('common.Enrolled_Student') }}</small>
                                            @else
                                                <small class="text-muted">{{ trans('common.Enrolled_Student') }}</small>
                                            @endif
                                        </div>
                                    ...
                                    <div class="card-body pt-2">
                                        ...
                                        <div class="d-flex mt-2" style="color: #5351e4;">
