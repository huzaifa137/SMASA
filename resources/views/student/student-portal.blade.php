                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{ trans('common.first_name') }} <span style="color: red;">(*)</span></label>
                                        <input type="text" name="firstname" class="form-control"
                                            placeholder="Enter firstname">
                                    </div>
                                    <div class="form-group">
                                        <label>{{ trans('common.last_name') }}<span style="color: red;">(*)</span></label>
                                        <input type="text" name="lastname" class="form-control"
                                            placeholder="Enter lastname">
                                    </div>
                                    <div class="form-group">
                                        <label>{{ trans('common.senior') }} <span style="color: red;">(*)</span></label>
                                    ...
                                    <div class="form-group">
                                        <label>{{ trans('common.stream') }}  <span style="color: red;">(*)</span></label>
                                        <input type="text" class="form-control" id="stream" name="stream"
                                            placeholder="Enter stream" value="{{ old('stream') }}">
                                    </div>

                                    <div class="form-group">
                                        <label>{{ trans('common.gender') }} <span style="color: red;">(*)</span> </label>
                                        <select name="gender" class="form-control">
                                            <option value="">{{ trans('common.select_gender') }}</option>
                                    ...
                                    <div class="form-group">
                                        <label>{{ trans('common.date_of_admission') }}</label>
                                    ...
                                    <div class="form-group">
                                        <label>{{ trans('common.place_of_birth') }}</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label>{{ trans('common.school') }} <span style="color: red;">(*)</span></label>
