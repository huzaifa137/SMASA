...
@section('content')
    <div class="side-app">
        ...
        <div class="row">
            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center"  style="background-color: #2C29CA;">
                        <h4 class="card-title mb-0 text-white"> {{ trans('common.students_list') }}</h4>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table id="schoolsTable" class="table table-striped table-bordered  align-middle">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="10" class="text-center">{{ trans('common.No_students_found') }}.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label>{{ trans('common.stream') }}</label>
