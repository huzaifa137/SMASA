                        ...
                        <form id="createStudentForm" method="POST" action="{{ route('students.store') }}">
                            ...
                            <div class="student-form-grid">
                                ...
                                <div class="form-group">
                                    <label>{{ trans('common.schools') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="form-group">
                                    <label>{{ trans('common.category') }} <span class="text-danger">*</span></label>
                                    <select name="Category" class="form-control select2" required>
                                        <option value="">-- {{ trans('common.select') }}--</option>
                                        <option value="ID">{{ trans('common.idaad') }} - ID</option>
                                        <option value="TH">{{ trans('common.thanawi') }}- TH</option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label>{{ trans('common.admission_year') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="form-group">
                                    <label>{{ trans('common.student_id') }} <span class="text-danger">*</span></label>
                                    <input type="text" name="Student_ID" class="form-control" id="Student_ID" readonly
                                        required>
                                </div>

                                <div class="form-group">
                                    <label>{{ trans('common.student_name') }} <span class="text-danger">*</span></label>
                                    <input type="text" name="Student_Name" class="form-control" required>
                                </div>

                                <div class="form-group">
                                    <label>{{ trans('common.student_name') }} (AR)</label>
                            ...
                            <div class="mt-4">
                                <button type="submit" class="btn text-white" style="background-color:#287C44;">
                                    <i class="fa-solid fa-paper-plane me-2"></i>{{ trans('common.submit') }}
                                </button>
                            </div>
