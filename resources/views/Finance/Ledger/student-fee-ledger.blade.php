...
@section('page-header')
    <div class="fin-hero mt-5">
        <div style="position:relative;z-index:1;">
            <div class="hero-badge"><i class="fas fa-user-graduate"></i> Finance — Ledgers</div>
            <h1>Student Fee Ledger</h1>
            <p>Search for a student to view their full statement of account</p>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <div style="display:flex;gap:.5rem;flex-wrap:wrap;margin-bottom:1.25rem;">
        ...
        <a href="{{ route('finance.ledger.student-fees') }}" class="btn-fin btn-primary-fin btn-sm"><i class="fas fa-user-graduate"></i> Student Fee Ledger</a>
    ...
    <div class="fin-card">
        <div class="fin-card-header">
            <h3><i class="fas fa-search"></i> Find a Student</h3>
        </div>
        <form method="GET" class="filters">
            ...
            <div class="filter-actions">
                <button class="btn-fin btn-primary-fin"><i class="fas fa-search"></i> Search</button>
            </div>
        </form>
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            @foreach($students as $student)
                                <tr>
                                    <td class="amount-mono">{{ $student->admission_number }}</td>
                                    <td><strong>{{ $student->firstname }} {{ $student->lastname }}</strong></td>
                                    <td>
                                        <a href="{{ route('finance.ledger.student-fees.detail', $student->id) }}" class="btn-fin btn-outline-fin btn-sm">
