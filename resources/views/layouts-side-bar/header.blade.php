        ...
        <div class="modal-content">
            ...
            <form id="passwordUpdateForm" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <!-- Password Requirements - Simplified (Only 4 characters minimum) -->
...
<script>
    ...
    $(document).ready(function () {
        ...
        // Real-time password validation (simplified - only 4 characters)
        ...
        function updatePasswordStrength(isValid) {
            ...
            if (isValid) {
                ...
                strengthText.html('<i class="fas fa-exclamation-triangle text-warning"></i> Password must be at least 4 characters');
        ...
        $('#passwordUpdateForm').on('submit', function (e) {
            ...
            // Validate password requirements (simplified - only 4 characters)
