...
<head>
     ...
     <style>
          ...
          .back-to-top {
               ...
               /* Matching the site's primary color tone */
               color: #fff;
               border-radius: 50%;
               text-align: center;
               line-height: 50px;
                         ...
                         <div class="caption">
                              <div class="container">
                                   <div class="col-md-6 col-sm-12">
                                        ...
                                        <h3>Techsate presents a comprehensive, cloud-based solution for Theology
                                             Schools, primary, and curriculum programs.</h3>
                                        <a href="{{route('users.login')}}"
                                             class="section-btn btn btn-default smoothScroll">Login</a>
                                   </div>
                              </div>
                         </div>
                    </div>
                         ...
                         <div class="caption">
                              <div class="container">
                                   <div class="col-md-6 col-sm-12">
                                        ...
                                        <h3>Smart Technologies introduces a comprehensive ecosystem designed
                                             specifically for the Islamic Theology institutes and non-islamic
                                             institutes.</h3>
                                        <a href="{{route('users.login')}}"
                                             class="section-btn btn btn-default smoothScroll">Login</a>
                                   </div>
                         ...
                         <div class="caption">
                              <div class="container">
                                   <div class="col-md-6 col-sm-12">
                                        ...
                                        <h3>Manage lessons, grades, and student data from anywhere in the world.The
                                             First AI-Powered Mobile Solution for Islamic Theology Schools.</h3>
                                        <a href="{{route('users.login')}}"
                                             class="section-btn btn btn-default smoothScroll">Login</a>
                                   </div>
                              </div>
               ...
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="feature-thumb">
                              ...
                              <p>A central hub for course materials , assignment submissions, and financial aid
                                   tracking.</p>
                         </div>
                    </div>
               ...
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                         <div class="about-info">
                              <h2>Join the movement of schools using technology to spread the Word more effectively.
                              </h2>
                              ...
                              <figure>
                                   ...
                                   <figcaption>
                                        ...
                                        <p>Say goodbye to manual data entry. Our system directly integrates with the
                                             IDAAD and Thanawi Examination portals,
                                             allowing for instant registration and verification of candidate students.
                                        </p>
                                   </figcaption>
                              </figure>
                              ...
                              <figure>
                                   ...
                                   <figcaption>
                                        ...
                                        <p>Identify trends and performance analytics across the entire academic
                                             term/year .</p>
                                   </figcaption>
                              </figure>
                              ...
                              <figure>
                                   ...
                                   <figcaption>
                                        ...
                                        <p>ensuring that students, faculty, and administrators can work in the language
                    ...
                    <div class="col-md-offset-1 col-md-4 col-sm-12">
                         <div class="entry-form">
                              <img src="{{asset('/asset/images/courses-image1.png')}}"
                                   alt="School management system features">
                         </div>
                    </div>
               ...
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                         <div class="contact-image">
                              <img src="{{asset('/asset/images/contact-image.png')}}" class="img-responsive"
