                ...
                <div class="card shadow-lg">
                    <div class="card-header border-0 bg-transparent pt-4">
                        <div class="d-flex align-items-center justify-content-between w-100">
                            ...
                            <div>
                                <h3 class="mb-0 fw-bold">{{ Helper::schoolNameBySchoolID(Session('LoggedSchool')) }}</h3>
                            </div>
                            ...
                            <div class="card p-4 shadow-sm border rounded">
                                ...
                                <div class="p-3 border rounded bg-light">
                                    ...
                                    <form method="POST" action="{{ route('schools.store.profile') }}"
                                        ...
                                        <input type="hidden" name="school_id" value="{{ Session('LoggedSchool') }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="admissionPrefix" class="form-label">Admission Number
                                                                Prefix</label>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="admissionStart" class="form-label">Admission Number
                                                                Begins At</label>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group mb-0">
                                                            <label for="admissionSuffix" class="form-label">Admission Number
                                                                Suffix</label>
                                        ...
                                        <div class="mt-4">
                                            <button class="btn btn-primary w-100 w-lg-auto text-wrap text-break"
                                                type="submit">
