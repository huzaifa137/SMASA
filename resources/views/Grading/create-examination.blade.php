    ...
    <div class="side-app">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card bg-primary">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0 text-white">
                            <i class="bi bi-pencil-square me-2"></i> {{ trans('common.create_exam') }}
                        </h4>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="ExaminationName" style="font-weight: bolder">{{ trans('common.examination_name') }} *</label>
                                        <?php
                                        ...
                                        <div class="invalid-feedback" id="examNameError" style="display: none;">
                                            {{ trans('common.please_select_an_examination_name') }}.
                                        </div>
                                    </div>
                                </div>

                                <div class="col-md-3">
                                    <label for="Examination Name" style="font-weight: bolder">{{ trans('common.active_year') }}</label>
                                    <input type="number" class="form-control" placeholder="Year" name="year"
                                        value="{{ $activeYear }}" readonly required>
                                </div>

                                <div class="col-md-3">
                                    <label style="font-weight: bolder;">{{ trans('common.activate_marks_upload') }}</label>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-3">
                                    <button id="submit-button" type="submit" class="btn btn-primary">
                                        <i class="bi bi-plus-circle me-2"></i> {{ trans('common.create_exam') }}
                                    </button>
                                </div>
                            </div>
                        </form>
                ...
                <div class="mb-3"
                    style="background: linear-gradient(135deg, #f8f9ff 0%, #f0f2ff 100%); padding: 20px; border-radius: 10px; border-left: 4px solid #2C29CA;">
                    <label for="yearFilter" class="form-label"
                        style="font-weight: 600; color: #2C29CA; font-size: 16px; margin-bottom: 10px; display: block;">
                        <i class="fas fa-calendar-alt" style="margin-right: 8px; color: #2C29CA;"></i>{{ trans('common.select_year') }}
                    </label>
        ...
        font-weight:600;
    ">
                        <i class="fas fa-eye me-1"></i> {{ trans('common.show_active_examination_upload') }}
                    </button>
               ...
               border-left: 4px solid #28a745;">
                            ...
                            <label style="font-weight:600; color:#155724; font-size:16px;">
                                <i class="fas fa-toggle-on me-2"></i> {{ trans('common.active_examination') }}
                            </label>
                        </div>
                            ...
                            <table id="activeExamsTable" class="table table-striped table-bordered"
                                ...
                                <thead style="display:none;">
                                    <tr>
                                        ...
                                        <th>{{ trans('common.examination') }}</th>
                ...
                <div class="table-responsive"
                    ...
                    <table id="examsTable" class="table table-striped table-bordered"
                        ...
                        <thead
                            style="background: linear-gradient(90deg, #2C29CA 0%, #2C29CA 100%); color: white; display:none;">
                            <tr>
                                <th style="padding: 16px 12px; border: none; font-weight: 600; text-align: center;">{{ trans('common.number') }}</th>
                                <th style="padding: 16px 12px; border: none; font-weight: 600;">{{ trans('common.examination_name') }}</th>
                                <th style="padding: 16px 12px; border: none; font-weight: 600;">{{ trans('common.classification') }}</th>
                                <th style="padding: 16px 12px; border: none; font-weight: 600; text-align: center;">{{ trans('common.active') }}
                                </th>
                            </tr>
                        </thead>
