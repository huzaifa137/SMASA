...
Route::group(['prefix' => LaravelLocalization::setLocale(), 'middleware' => ['localized']], function () {
    ...
    Route::controller(\App\Http\Controllers\NlscTopicController::class)
        ...
        ->group(function () {
            ...
            Route::delete('/nlsc-topics-all', 'destroyAllTopics')->name('nlsc-topics.delete-all');
    ...
    Route::prefix('examinations')
        ...
        ->group(function () {
            ...
            Route::get('/{id}/discipline', 'disciplineEntry')->name('discipline.entry');
            Route::post('/{id}/discipline/save', 'saveDisciplineRatings')->name('discipline.save');
